#include "motor.h"
/**
 * @brief Функция управления левым мотором. Используемые пины PA5, PA6 (направление) и
...
{   
    ...
    {
        WRITE_REG(GPIOA->BSRR, GPIO_BSRR_BR_5 | GPIO_BSRR_BR_6); // Оба выключены, плавное торможение
        WRITE_REG(TIM2->CCR3, 0);
    }
}

/**
 * @brief Функция управления правым мотором. Используемые пины PA7 (направление), PB6 (направление) и
